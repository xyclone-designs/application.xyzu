...
{
	[Register("xyzu/widgets/controls/DirectoryItem")]
	public class DirectoryItem : ConstraintLayout
	{
		public static class Ids
		{
			public const int Layout = Resource.Layout.xyzu_widget_control_directoryitem;

			public const int DirectoryIsSelected_AppCompatCheckBox = Resource.Id.xyzu_widget_control_directoryitem_directoryisselected_appcompatcheckbox;
			public const int DirectoryTitle_AppCompatButton = Resource.Id.xyzu_widget_control_directoryitem_directorytitle_appcompatbutton;
			public const int DirectoryChildren_RecursiveItemsRecyclerView = Resource.Id.xyzu_widget_control_directoryitem_directorychildren_recursiveitemsrecyclerview;
		}

		public DirectoryItem(Context context) : this(context, null!) { }
		public DirectoryItem(Context context, IAttributeSet attrs) : this(context, attrs, Resource.Style.Xyzu_Widget_Control_DirectoryItem) { }
