...
namespace Xyzu.Fragments.Settings.UserInterface.Library
{
	...
	public class AlbumsPreferenceFragment : BasePreferenceFragment, IAlbumsSettings
	{
		public const string FragmentName = "Xyzu.Fragments.Settings.UserInterface.Library.AlbumsPreferenceFragment";

		public static class Keys										
		{
			public const string IsReversed = "settings_userinterface_library_albums_isreversed_switchpreference_key";
			public const string LayoutType = "settings_userinterface_library_albums_layouttype_listpreference_key";
			public const string SortKey = "settings_userinterface_library_albums_sortkey_listpreference_key";
		}
		...
		public override void OnResume()
		{
			...
			AppCompatActivity?.SetTitle(Resource.String.settings_userinterface_library_albums_title);
		...
		public override void OnPropertyChanged([CallerMemberName] string? propertyName = null)
		{
			...
			switch(propertyName)
			{
				...
				LayoutTypePreference != null:
					if (IAlbumsSettings.Options.LayoutTypes.AsEnumerable().NeatlyOrdered().Index(LayoutType) is int layouttypeindex)
						LayoutTypePreference.SetValueIndex(layouttypeindex);
					break;
											  
				case nameof(SortKey) when
				SortKeyPreference != null:
					if (IAlbumsSettings.Options.SortKeys.AsEnumerable().Index(SortKey) is int sortkeyindex)
