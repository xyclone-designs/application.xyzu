...
namespace Xyzu.Fragments.Settings.UserInterface.Library
{
	...
	public class QueuePreferenceFragment : BasePreferenceFragment, IQueueSettings
	{
		public const string FragmentName = "Xyzu.Fragments.Settings.UserInterface.Library.QueuePreferenceFragment";

		public static class Keys										
		{
			public const string LayoutType = "settings_userinterface_library_queue_layouttype_listpreference_key";
		}
		...
		public override void OnResume()
		{
			...
			AppCompatActivity?.SetTitle(Resource.String.settings_userinterface_library_queue_title);

			AddPreferenceChangeHandler(LayoutTypePreference);
