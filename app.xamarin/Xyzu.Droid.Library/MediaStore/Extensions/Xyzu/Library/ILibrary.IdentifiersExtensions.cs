...
namespace Xyzu.Library
{
	...
	{
		public static void ToSelectionAndArgs(this ILibraryDroid.IIdentifiers? identifiers, bool exclusive, ILibraryDroid.ISettings? settings, out string selection, out string[] selectionargs)
		{
		...
		public static (string selection, string[] selectionargs) ToSelectionAndArgs(this ILibraryDroid.IIdentifiers? identifiers, bool exclusive, ILibraryDroid.ISettings? settings)
		{
