...
namespace Xyzu.Library
{
	public partial interface IScanner
	{
		public interface INotification
		{
			...
			IContentTexts ContentTextsPreparing { get; set; }
			IContentTexts ContentTextsReading { get; set; }
			IContentTexts ContentTextsRemoving { get; set; }
			IContentTexts ContentTextsSaving { get; set; }
			IContentTexts ContentTextsScanning { get; set; }

			NotificationCompat.Builder CompatBuilder { get; set; }
			NotificationCompat.Action CompatActionCancel { get; set; }
			NotificationCompat.BigTextStyle CompatBigTextStyle { get; set; }

			void Update(string? contenttext, string? subtext);

			public class Default : INotification
			{
				public Default(int id, string channelid, string channelname)
				{
					Id = id;
					ChannelId = channelid;
