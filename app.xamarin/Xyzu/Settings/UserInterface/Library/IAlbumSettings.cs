...
{
	public interface IAlbumSettings<T> : ISettings<T>
	{
		T SongsIsReversed { get; set; }
		T SongsLayoutType { get; set; }
		T SongsSortKey { get; set; }
	}
	public interface IAlbumSettings : ISettings
	{
		public new class Defaults : ISettings.Defaults
		{
			...
			public static readonly ModelSortKeys SongsSortKey = ModelSortKeys.TrackNumber;

			public static readonly IAlbumSettings AlbumSettings = new Default
			{
		...
		{
			public new const string Base = IUserInterfaceSettings.Keys.Base + "." + nameof(IAlbumSettings);
		...
		public new class Options : ISettings.Options
		{
			...
			public class SongsSortKeys : IAlbum.SortKeys.SongSortKeys { }
		}
		...
		public new class Default : ISettings.Default, IAlbumSettings
		{
			public Default()
			{
		...
		public new class Default<T> : ISettings.Default<T>, IAlbumSettings<T>
		{
