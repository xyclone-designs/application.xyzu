...
{
	public interface IGenreSettings<T> : ISettings<T>
	{
		T SongsIsReversed { get; set; }
		T SongsLayoutType { get; set; }
		T SongsSortKey { get; set; }
	}
	public interface IGenreSettings : ISettings
	{
		public new class Defaults : ISettings.Defaults
		{
			...
			public static readonly IGenreSettings GenreSettings = new Default
			{
		...
		{
			public new const string Base = IUserInterfaceSettings.Keys.Base + "." + nameof(IGenreSettings);
		...
		public new class Options : ISettings.Options
		{
			...
			public class SongsSortKeys : IGenre.SortKeys.SongSortKeys { }
		}
		...
		public new class Default : ISettings.Default, IGenreSettings
		{
			public Default()
			{
		...
		public new class Default<T> : ISettings.Default<T>, IGenreSettings<T>
		{
